...
from models.poolresnet import PoolResNet18
...
def test(epoch):
    ...
    if not os.path.isdir('checkpoint'):
        os.mkdir('checkpoint')
    torch.save(state, './checkpoint/adaptpool.pth')
    if acc > best_acc:
        best_acc = acc
...
if __name__ == '__main__':
    ...
    print("TESTING AdaptiveAvgPool2d((1, 1)) ")
    # Model
    ...
    if args.resume:
        ...
        checkpoint = torch.load('./checkpoint/adaptpool.pth')
